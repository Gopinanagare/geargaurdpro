...
const Dashboard = ({ onNavigate, historyData = [] }) => {
  ...
  return (
    <div className="bg-background text-on-background min-h-screen lg:h-screen flex flex-col font-inter lg:overflow-hidden">
      <header className="bg-zinc-950 border-b border-zinc-800 flex justify-between items-center w-full px-4 lg:px-6 py-3 z-50 flex-shrink-0 sticky top-0">
      ...
      <main className="flex-1 p-4 max-w-7xl mx-auto w-full overflow-y-auto lg:overflow-hidden flex flex-col gap-4 pb-24 lg:pb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 flex-1 lg:overflow-hidden lg:min-h-0">
          ...
          <section className="md:col-span-4 bg-zinc-900/50 border border-zinc-800 p-5 rounded-2xl flex flex-col justify-between lg:min-h-0">
            ...
            <div className="flex flex-col items-center gap-4 flex-1 justify-center">
              <div className="relative w-28 h-28 lg:w-32 lg:h-32 flex items-center justify-center">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <span className="text-2xl lg:text-3xl font-black text-on-surface">{stats.avgHealth || '--'}</span>
          ...
          {/* Quick Features Grid */}
          <section className="md:col-span-3 grid grid-cols-2 md:grid-cols-1 md:grid-rows-2 gap-3 lg:min-h-0">
            {[
              ...
              <button key={card.view} onClick={() => onNavigate(card.view)} className={`p-4 rounded-2xl border transition-all hover:bg-zinc-900 text-left flex flex-col justify-center gap-1 ${card.color}`}>
                ...
                <p className="text-[8px] text-zinc-500 uppercase tracking-wider hidden lg:block">{card.desc}</p>
              </button>
            ))}
          </section>

          {/* Recent Activity (Limit to 2) */}
          <section className="md:col-span-5 bg-zinc-900/30 border border-zinc-800 rounded-2xl overflow-hidden flex flex-col lg:min-h-0">
            ...
            <div className="flex-1 lg:overflow-y-auto lg:min-h-0 divide-y divide-zinc-800/30">
              {historyData.length > 0 ? (
                ...
                <div className="h-full min-h-[100px] flex flex-col items-center justify-center p-6 opacity-30">
